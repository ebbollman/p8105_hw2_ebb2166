...
Cleaning steps included: separate date, convert month to name instead of number, drop date; creating character president variable to replace numerical GOP and DEM specific president variables; dropping unecessary variables.
...
Cleaning steps included: separating by separate date, convert month to name instead of number, dropping the day variable, and then arranging by year and month. This snp_df now shares variable names 'year' and 'month_name' with the pols_df. 